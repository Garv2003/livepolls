import { MaxWidthWrapper, Icons, TopicCreator } from "@/components";
import { Star } from "lucide-react";
import { redis } from "@/lib/redis";

export default async function Home() {
  const serveredRequests = await redis.get("served-requests");
            ...
            <h1 className="relative leading-snug w-fit tracking-tight text-balance mt-16 font-bold text-gray-900 text-5xl md:text-6xl">
              ...
              <span className="whitespace-nowrap">
                ...
                <span className="relative">
                  i
                  <span className="absolute inset-x-0 -top-1.5 -translate-x-3.5">
              ...
              <div className="flex flex-col gap-1 justify-between items-center">
                ...
                <p>
                  <span className="font-semibold">
                    {Math.ceil(Number(serveredRequests) / 10) * 10}
                  </span>{" "}
                  served requests
                </p>
              </div>
